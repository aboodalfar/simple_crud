...
<div class="container">
	<div class="row">
<form method="post" class="form-horizontal col-md-6 col-md-offset-3" action="<?php echo site_url('user/update_user')?>">
...
<?php //echo print_r($crud_data); ?>
	...
	<div class="form-group">
	    ...
	    <div class="col-sm-10">
	      <input type="email" name="email" value="<?php echo $crud_data->email; ?>" class="form-control" id="input1" placeholder="E-Mail" />
	    </div>
	</div>
